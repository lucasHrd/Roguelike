// 📁 Fichier : entities/enemies/RedDuckEnemy.java
...
public class RedDuckEnemy implements EnemyBase {
    ...
    public RedDuckEnemy(float x, float y, Player target) {
        ...
        this.textureLeft = new Texture("assets/redduck1.png");
        this.textureRight = new Texture("assets/redduck2.png");
    }
    ...
    public void draw(SpriteBatch batch) {
        ...
        batch.draw(currentTexture, position.x(), position.y(), 32, 32); // Redimensionnement ici
    }
    ...
    public Hitbox getHitbox() {
        return new Hitbox(position.x(), position.y(), 32, 32); // Correspond à la taille affichée
    }
}
