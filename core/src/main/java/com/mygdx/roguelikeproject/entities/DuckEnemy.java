...
public class DuckEnemy implements EnemyBase {
    ...
    public DuckEnemy(float x, float y, Player target) {
        ...
        this.textureLeft = new Texture("assets/duck1.png");
        this.textureRight = new Texture("assets/duck2.png");
    }
    ...
    public Hitbox getHitbox() {
        return new Hitbox(position.x(), position.y(), 32, 32); // Ajuste si nécessaire selon la taille du sprite
    }
}
